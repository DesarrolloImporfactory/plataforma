<x-app-layout>
    ...
    <section class="mt-18 py-6">
        <h1 class="text-gray-500 fond-bold dark:text-white text-center text-3xl mb-6">CONTENIDO</h1>
        <div
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-24 w-full object-cover"
                        src="{{ asset('img/home/caja1.png') }}" alt="">
                </figure>
                {{-- <header class="mt-2">
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-24 w-full object-cover" src="{{ asset('img/home/caja2.png') }}"
                        alt="">
                </figure>
                {{-- <header class="mt-2">
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-24 w-full object-cover" src="{{ asset('img/home/caja3.png') }}"
                        alt="">
                </figure>
                {{-- <header class="mt-2">
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-24 w-full object-cover" src="{{ asset('img/home/caja4.png') }}"
                        alt="">
                </figure>
                {{-- <header class="mt-2">
