                                        ...
                                        @if ($usuarios->count())
                                            @foreach ($usuarios as $item)
                                                <tr>
                                                    ...
                                                    <td>USD {{ $item->comisiones->sum('valor') }}$</td>
                                                    <td>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item "
                                                                    wire:click="comisiones({{ $item->id }})"
                                                                    type="button" data-bs-toggle="modal"
                                                                    data-bs-target="#comisionesModal"><i
                                                                        class="fa-solid fa-pen-to-square "></i>
                                                                    Comisiones</a>
                                                            </li>
                                                        </ul>
        ...
        Livewire.on('deleteUser', userId => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Livewire.emitTo('vendedor.admin-vendedores', 'delete', userId);
                }
            })
        });
    </script>
