<section>
    <h1 class="text-2xl fond-bold text-white">Requerimientos del curso</h1>
    <hr class="py-2">
    ...
    <article class="dark:bg-gray-100 overflow-hidden shadow-lg rounded mb-6">
        <div class="p-4">
            <form action="" wire:submit.prevent='store'>
                ...
                <x-input class="w-full mt-2" wire:model='name' placeholder="agregar el nombre del requerimiento"></x-input>
